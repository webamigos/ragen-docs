...
| **Delete threads** | on | Off, nobody in the organization can delete a conversation: **Delete** disappears from the thread menu. Chat keeps working. The public API refuses to delete a thread or a message with `403`. This is meant for a showcase organization whose example threads every visitor should see |
