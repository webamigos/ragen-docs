---
title: 'Core Concepts: Projects, Organizations, and API Keys'
...
An API key grants programmatic access to Ragen AI on behalf of one organization, scoped to one assistant or to the whole knowledge base — a choice made when the key is created. You use it in the `Authorization: Bearer <key>` header on every request.
