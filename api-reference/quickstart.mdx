---
title: 'Ragen AI API Quickstart — SDK Setup and First Call'
sidebarTitle: 'Quickstart'
description: 'Install the TypeScript SDK, send your first chat completion, and stream tokens from your self-hosted Ragen AI instance in under five minutes.'
---
