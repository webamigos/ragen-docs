---
title: 'Authenticating Requests to the Ragen AI API'
sidebarTitle: 'Authentication'
description: 'Learn the API key format, how to pass the Authorization header, and how to handle common authentication errors in Ragen AI.'
---
...
The `sk-` prefix signals that the value is an API secret key. The `<keyId>` portion identifies the key record in the database; the `<secret>` portion is the credential that authenticates the request. Both parts are required.
